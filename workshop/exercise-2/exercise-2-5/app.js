    ...
    // }, 2000);
        ...
        const aTimer = setInterval(function(){
            ...
            if (racers[0]["progress"] >= 100) {
                ...
                ranking.push(racers[0]["name"]);
                console.log(`${racers[0]["name"]} has finished the race!`);
                if (ranking.length===3) {
                    console.log(`Congratulations to ${ranking[0]} for coming in 1st place!`);
                    console.log(`${ranking[1]}, you are the first place loser!`);
                    console.log(`${ranking[2]}... reconsider your options.`);
                };
            };
        ...
        const bTimer = setInterval(function(){
            ...
            if (racers[1]["progress"] >= 100) {
                ...
                ranking.push(racers[1]["name"]);
                console.log(`${racers[1]["name"]} has finished the race!`);
                if (ranking.length===3) {        
                    console.log(`Congratulations to ${ranking[0]} for coming in 1st place!`);
                    console.log(`${ranking[1]}, you are the first place loser!`);
                    console.log(`${ranking[2]}... reconsider your options.`);};
        ...
        const cTimer = setInterval(function(){
            ...
            if (racers[2]["progress"] >= 100) {
                ranking.push(racers[2]["name"]);
                clearInterval(cTimer);
                console.log(`${racers[2]["name"]} has finished the race!`);
                if (ranking.length===3) {
                    console.log(`Congratulations to ${ranking[0]} for coming in 1st place!`);
                    console.log(`${ranking[1]}, you are the first place loser!`);
                    console.log(`${ranking[2]}... reconsider your options.`);
